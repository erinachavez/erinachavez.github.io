<head>
	...
	<style>
		...
		#saveModal{display: none; z-index: 9; width: 350px; background-color: #ffffff; padding: 15px; position: fixed; top: 5vw; left: 50%; margin-left: -175px; border: 5px solid #000000;}
			#saveModal p{margin: 0; text-align: justify;}
			#saveModal .container{}
				#saveModal .container button{display: block; background: none; border: solid 3px #000000;}
				#saveModal .container button:hover{background-color: #000000; color: #ffffff; cursor: pointer;}
	</style>
</head>
<body>
	...
	<div id='saveModal'>
		<p>
			...
			<br><br>
			Would you like to save a copy for yourself and one to Pixel Art Creator's site?
		</p>
		<br>
		<div class='container'>
			<button id='databaseSave' onclick='databaseSave()'>Save to Pixel Art Creator</button>
			<button id='saveImage2' onclick='saveImage2()'>Just save a copy for myself</button>
		</div>
	</div>
</body>
